import os, traceback, string, secrets
    ...
    async def ANERROROCCURED(self, ctx:commands.Context, error):
        if isinstance(error, commands.CommandNotFound):
            ...
            permmap = {
                ...
                "CanEditApplicationForm": "Edit Applications",
                ...
                "CanSendVoiceMessages": "Send Messages",
                "CanCreateScrims": "Create Scrims",
                "CanManageTournaments": "Create Tournaments",
                ...
                "CanViewFormResponses": "Form Responses",
                "CanViewPollResponses": "Poll Results",
                ...
                "CanJoinStreamVoice": "Join Voice",
                "CanCreateStreams": "Add Stream",
                "CanSendStreamMessages": "Send Messages in Streams",
                "CanAddStreamVoice": "Add Voice to Streams",
                "CanUseVoiceActivityInStream": "Use Voice Activity Detection in Streams"
            }
